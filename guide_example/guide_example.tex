...
% options
% ---------------------------------------------------------------------------------------- %
\documentclass[submission, anonymous]{sedimentologika}
% ---------------------------------------------------------------------------------------- %
%
...
}
{
  \translation{australian}{Translations}{
    ...
    Should you need further help with this, please contact the editorial team \href{mailto:support@sedimentologika.org}{support@sedimentologika.org}.
  }
}
...
\textbf{However}, \href{https://sedimentologika.org/manuscript-guidelines}{minimum formatting requirements} apply and upon acceptance authors using \LaTeX\space should submit their final version using the \Sedimentologika\space \LaTeX\space template.
...
Please refer to \Sedimentologika's \href{https://sedimentologika.org/figures-tables-guidelines}{figure and table guidelines} for further detail.
...
Regardless of font choice, the minimum character height must be no less than \qty{1.5}{\milli\metre} ($\approx$~\qty{8}{pt} Noto Sans) at final production size for accessibility purposes.
...
% ---------------------------------------------------------------------------------------- %
\onecolumn
\input{example_longtable.tex} % a way to keep complicated, or long tables from cluttering this main file.
\twocolumn
